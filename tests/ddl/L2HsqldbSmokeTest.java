...
public class L2HsqldbSmokeTest {
    ...
    static void runPositiveInserts(Connection conn){
        ...
        assertOk(conn,"S1-20","sales_sales_order","INSERT INTO \"sales_sales_order\" (\"id\",\"created_at\",\"updated_at\",\"order_number\",\"customer_id\",\"order_date\",\"status\",\"currency\",\"total_amount\",\"price_list_id\") VALUES ('ord-001',TIMESTAMP '2026-01-15 09:00:00',TIMESTAMP '2026-01-15 09:00:00','ORD-001','cust-001',DATE '2026-01-10','draft','USD',200.0000,'pl-001')");
    ...
    static void runOnDeleteTests(Connection conn){
        ...
        try(Statement st=conn.createStatement()){
            st.executeUpdate("INSERT INTO \"sales_sales_order\" (\"id\",\"created_at\",\"updated_at\",\"order_number\",\"customer_id\",\"order_date\",\"status\",\"currency\",\"total_amount\") VALUES ('ord-002',TIMESTAMP '2026-01-15 09:00:00',TIMESTAMP '2026-01-15 09:00:00','ORD-002','cust-001',DATE '2026-01-11','draft','USD',50.0000)");
