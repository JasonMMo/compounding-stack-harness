...
- **부수 보안 발견 (security.md 기록)**: CAV-1 `AuthController.java` demo password (M1 stub, M2 JWT 교체 시 삭제) / CAV-2 `@colbymchenry/codegraph` 1인 메인테이너 — `.npmrc` 버전 고정 권장. 둘 다 informational, BLOCK 아님.
